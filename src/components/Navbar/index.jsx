        ...
        <nav className="h-[50px] fixed bg-primary-blue flex items-center w-screen pl-[14px] md:h-[90px] md:justify-center lg:pl-[100px]">
            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex items-center h-full justify-end gap-[27px] pr-[14px] md:hidden">
                    <IconContainer src={search} height={17} width={17} />
                    <IconContainer src={admin} height={16} width={16} />
                ...
                <ul className={`${styles.navMenuMobile} ${active && styles.active}`}>Nigga Marda</ul>

                <ul
                    className={`${styles.navMenuDesktop} hidden md:flex h-full items-center justify-end lg:pr-[100px] md:pr-[24px] lg:gap-[100px] md:gap-[50px] `}>
                    <li>Item1</li>
                    <li>Item2</li>
                    <li>Item3</li>
                    <li>Item4</li>
